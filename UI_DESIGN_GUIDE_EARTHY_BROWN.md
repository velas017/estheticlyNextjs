# UI Design Guide - Earthy Brown Theme

This guide extracts all UI patterns, components, and styles for the EstheticLY website using an earthy brown color palette. It follows the same reusable design system structure for consistency.
...
```css
/* Brand Colors */
--color-primary: #937a62;        /* Earthy Brown - CTAs, buttons */
--color-primary-hover: #7d6750;  /* Darker Brown - Hover states */
...
/* Mobile nav link hover - earthy brown accent */
...
### 2. Buttons
```css
/* Primary Button (Earthy Brown CTA) */
.button-primary {
  ...
  font-size: 16px;
  font-weight: 500;
  border: 2px solid #937a62;
  cursor: pointer;
  transition: all 0.3s ease;
  box-shadow: 0 4px 12px rgba(147, 122, 98, 0.3);
}
...
.button-primary:hover {
  ...
  box-shadow: 0 6px 16px rgba(147, 122, 98, 0.4);
}
...
/* Service card duration badge - earthy brown accent */
...
.form-input:focus {
  outline: none;
  border-color: #937a62;
  box-shadow: 0 0 0 3px rgba(147, 122, 98, 0.1);
}
...
/* Booking info card */
.booking-info-card {
  background: rgba(147, 122, 98, 0.05);
  border: 1px solid rgba(147, 122, 98, 0.2);
  border-radius: 12px;
  padding: 24px;
}
```
...
```css
/* Mission content card - earthy brown accent */
.mission-content {
  background: linear-gradient(135deg, rgba(147, 122, 98, 0.05) 0%, rgba(147, 122, 98, 0.02) 100%);
  border: 2px solid #937a62;
  border-radius: 20px;
  padding: 64px;
  box-shadow: 0 8px 24px rgba(147, 122, 98, 0.15);
}
...
.mission-decorative {
  background: radial-gradient(circle, rgba(147, 122, 98, 0.1) 0%, transparent 70%);
}
```

### 7. Interactive Links & Accents
```css
...
/* Prep card hover title */
.prep-card:hover .card-title {
  color: #937a62;
}

/* Book button (aftercare) */
.book-button {
  background-color: #937a62;
  color: #ffffff;
  padding: 12px 24px;
...
### 8. Mid-Banner Section
```css
/* Full-width earthy brown banner */
.mid-banner {
  padding: 80px 0;
  background: #937a62;
  color: #ffffff;
...
/* More services card with earthy brown gradient */
.more-services-card {
  background: linear-gradient(135deg, rgba(147, 122, 98, 0.3) 0%, #f7f7f7 100%);
  border-radius: 16px;
  padding: 48px;
  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.12);
...
/* globals.css */
:root {
  /* Brand Colors - Earthy Brown Theme */
...
1. **Color Customization**: The primary color is set to Earthy Brown (#937a62) — update this value and its derivatives to change the brand identity
...
This design system can be adapted for any professional service website, e-commerce platform, or corporate site while maintaining the clean, modern aesthetic with a warm, earthy character.